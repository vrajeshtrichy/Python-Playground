...
# The result of the merge is [1]. Note that because m = 0, there are no elements in nums1. The 0 is only there to
    ...
    def merge(self, nums1: list[int], m: int, nums2: list[int], n: int) -> None:
        ...
        while j >= 0:
            if i >= 0 and nums1[i] > nums2[j]:
                nums1[insertion_index] = nums1[i]
                i -= 1
            else:
                nums1[insertion_index] = nums2[j]
                j -= 1
            insertion_index -= 1
        ...
        #     if i >= 0 and nums1[i] > nums2[j]:
        #         print("1: ", nums1[insertion_index], nums1[i])
        #         nums1[insertion_index] = nums1[i]
        #         i -= 1
        #     else:
        #         print("2: ", nums1[insertion_index], nums2[j])
        #         nums1[insertion_index] = nums2[j]
        #         j -= 1
        #
        #     insertion_index -= 1
